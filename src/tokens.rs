pub fn eu4_tokens_resolver() -> eu4save::BasicTokenResolver {
    let data = include_bytes!(concat!("..", "/assets", "/tokens", "/tokens", "/eu4.txt"));
...
pub fn ck3_tokens_resolver() -> ck3save::BasicTokenResolver {
    let data = include_bytes!(concat!("..", "/assets", "/tokens", "/tokens", "/ck3.txt"));
...
pub fn vic3_tokens_resolver() -> vic3save::BasicTokenResolver {
    let data = include_bytes!(concat!("..", "/assets", "/tokens", "/tokens", "/vic3.txt"));
...
pub fn hoi4_tokens_resolver() -> hoi4save::BasicTokenResolver {
    let data = include_bytes!(concat!("..", "/assets", "/tokens", "/tokens", "/hoi4.txt"));
